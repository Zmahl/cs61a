...
class VendingMachine:
    ...
    def add_funds(self, amount):
        ...
        if self.stock == 0:
            return f'Machine is empty. Please restock. Here is your ${balance}.'
    ...
    def vend(self):
        print("DEBUG: ", self.balance, self.price)
        if self.stock == 0:
            ...
            if remainder == 0:
                ...
                return f'Here is your {self.type} and ${remainder} change.'
    def restock(self, stock_added):
        self.stock = self.stock + stock_added
...
def store_digits(n):
    ...
    for i in range(len(l) - 1, -1, -1):
        number = Link(int(l[i]), store_digits(l[:i]))
        return number
...
def path_yielder(t, value):
    ...
    "*** YOUR CODE HERE ***"
    if t.label == value:
        #Need to return as a list here to correctly add to label
        yield [t.label]
    ...
    for branch in t.branches:
        for path in path_yielder(branch, value):
            ...
            "*** YOUR CODE HERE ***"
            #Yields the new path, combining the current node label + the previous path
            yield [t.label] + path
def preorder(t):
    ...
    def helper(_t):
        ...
        for branch in _t.branches:
            for number in helper(branch):
                yield number

        
    return [item for item in helper(t)]
class Mint:
